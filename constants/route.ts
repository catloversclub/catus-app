export const ROUTES = {
  AUTH: {
    ...
    ONBOARDING: {
      ...
      STEP4_CREATE: "/(auth)/(onboarding)/step4-create" as const,
      STEP4_UPDATE: "/(auth)/(onboarding)/step4-update" as const,
      STEP5_CREATE: "/(auth)/(onboarding)/step5-create" as const,
      STEP5_UPDATE: "/(auth)/(onboarding)/step5-update" as const,
